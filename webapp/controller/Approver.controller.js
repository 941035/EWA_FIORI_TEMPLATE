sap.ui.define([
    ...
    function (Controller,coreLibrary,JSONModel,MessageBox) {
        ...
        return Controller.extend("com.parker.ewaformtemp.controller.Approver", {
            onInit: function () {
            ...
            _onWFObjectMatched: function (oEvent) {
                ...
                if (compData 
                    ...
                    this.ewaID = compData.startupParameters.Param1[0];
                    console.log(this.ewaID);
                    this.getEWADetails(this.ewaID);
            ...
            getEWADetails: function(ewaID){
                var that = this;
                this.oDataModel.read("/EWA_PROJECT_INFOSet", {
                    urlParameters: {
                        "$filter": "ZewaNo eq '" + ewaID + "'",
