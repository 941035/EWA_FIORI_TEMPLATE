		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EWA Form",
									"targetURL": "#comparkerewaformtemp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comparkerewaformtemp-display": {
								"semanticObject": "comparkerewaformtemp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.parker.ewaformtemp",
									"url": sap.ui.require.toUrl("com/parker/ewaformtemp")
								}
							}
						}
					}
